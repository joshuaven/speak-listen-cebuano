...
app.get('/MicError', (req, res) => {
  speakLog.info("Microphone errors pop out from the user unallowing them to use the service")
  res.sendStatus(200)
})
...
app.post("/uploadToServer", upload.single("soundBlob"), function (req, res, next) {
